...
function test_sign_1() {
  ...
  let msgHash = BigNumber.from("20693456676802104653139582814194312788878632719314804297029697306071204881418")
  let private_key = new FQ(BigNumber.from("1"))
  let signed = SignatureScheme.sign(msgHash, private_key, SignatureScheme.B())
...
function test_prehash_message_1() {
  ...
  let msg = BigNumber.from("20693456676802104653139582814194312788878632719314804297029697306071204881418")
  let result = SignatureScheme.prehash_message(msg)
...
function test_to_bytes_1() {
  ...
  let arg = BigNumber.from("20693456676802104653139582814194312788878632719314804297029697306071204881418")
  let resutls = SignatureScheme.to_bytes(arg)
...
function test_hash_secret_1() {
  ...
  let startTime: any = new Date();
  let arg = BigNumber.from("20693456676802104653139582814194312788878632719314804297029697306071204881418")
  let result = SignatureScheme.hash_secret_python(new FQ(BigNumber.from("1")), arg)
...
function test_hash_public_1() {
  ...
  let R = new Point(new FQ(BigNumber.from("4991609103248925747358645194965349262579784734809679007552644294476920671344")), new FQ(BigNumber.from("423391641476660815714427268720766993055332927752794962916609674122318189741")))
  let A = new Point(new FQ(BigNumber.from("16540640123574156134436876038791482806971768689494387082833631921987005038935")), new FQ(BigNumber.from("20819045374670962167435360035096875258406992893633759881276124905556507972311")))
  let M = BigNumber.from("20693456676802104653139582814194312788878632719314804297029697306071204881418")
