...
import { bnToBufWithFixedLength } from "./eddsa";
...
function testEddsaPack_1() {
  ...
  // Input
  const publicKeyX =
    "0x10440b6de1fc92536e20501e7513b5ca78d4c8c876450d97cfc2a4e24a4c67c7";
  const publicKeyY =
    "0x10dfbb7cd80bde2eeedbf9e0fad12819ca20be36b96a7f28c37c6a7550ed366c";

  // Output
  const eddsaPackOutput =
    "10dfbb7cd80bde2eeedbf9e0fad12819ca20be36b96a7f28c37c6a7550ed366c";

  const packed = EDDSAUtil.pack(publicKeyX, publicKeyY);
  console.log(packed === eddsaPackOutput);
...
function testEddsaPack_2() {
  ...
  // Input
  const publicKeyX =
    "0x191f8455196d7c9116065b69a745edbe3f5b6193125f48d818e16101b0ebd13f";
  const publicKeyY =
    "0x0729569e74800ba4344767d608ec54f12b14cc4404a8726b5f73ebf8b58f9a09";
...
function testEddsaPack_3() {
  ...
  // Input
  const publicKeyX =
    "0x1ae187c43a6b534be1ac60b335d5cc8c12a9d479339e5ce4134315e20c2940c4";
  const publicKeyY =
    "0x16fb785193a8657feb41b7944afde61fe05ea519621fa0f19d872a8fbba83463";
...
function testEddsaSign() {
  ...
  // console.log(result == "0x04ad08469a4a8622a661a793615ebddfa6ea2b72c8f1b02e33288ea2bd71cede0ed7f67939097ab95d3c9d8647e198f4ef523bf6cfb8da0ead89a57e27eff0d12ea6ac32cc118b1bc0aeb8f1be37f317f399197f9e41c8a90ecfe9e296be42e5")
...
function test_generateKeyPair() {
  ...
  const seedHex =
    "0x" + "7f16a4c491d3494c3bc8ef097e7c123a9da6fa8167631efd5f82b89e803b0682";
  ...
  console.log(
    keyPair.publicKeyY ===
      "4521439321743413283487130903749053907482128013050103604539374548984130428531"
  );
