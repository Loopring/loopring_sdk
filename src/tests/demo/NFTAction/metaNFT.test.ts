import { DEFAULT_TIMEOUT, LOOPRING_EXPORTED_ACCOUNT, LoopringAPI, web3 } from '../../test.MockData'
...
describe('metaNFT', function () {
  ...
  it('ipfsCid0ToNftID', () => {
    ...
    const nftID = '0x0880847b7587968f32ba6c741f9d797d9dc64971979922a80c4e590453b8dc2f'
    console.log(`ipfsCid0ToNftID: ipfs: `, ipfs, LoopringAPI.nftAPI.ipfsCid0ToNftID(ipfs))
  ...
  it('ipfsNftIDToCid', () => {
    ...
    console.log(`ipfsCid0ToNftID: nftID: `, nftID, LoopringAPI.nftAPI.ipfsNftIDToCid(nftID))
