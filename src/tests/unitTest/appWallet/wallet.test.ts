  ...
  it(
    ...
    async () => {
      const request: any = {
        ...
        txAwareHash:
          "0x7de6db4d1eb828442404daa7a70ee10a5c7d69c3f9685a8a52dc069fd53575bb",
      ...
      // };
      const forwarderModuleAddress =
        "0x46d4e3d3db8fcb401e5d4020b958755a3419b84b"; //walletModule.moduleAddress;
  ...
  it(
    ...
    async () => {
      ...
      const request: any = {
        ...
        txAwareHash:
          "0xaeaf14dc427a0fbfa3e60887fd46b7263907d415ff8e392a4429279322fb97c2",
      ...
      const response = await LoopringAPI.walletAPI.getApproveRecoverV2TypedData(
        LOOPRING_EXPORTED_ACCOUNT.chainId,
