...
> 3. As the maxFeeBips can't exceed 50%, let's set maxAllowBips = 50%
> 4. Let's set slippage as the slippage value user configured in UI (for example 0.1%)
